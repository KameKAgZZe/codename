...
<div class="container">
    ...
    <form:form method="POST" modelAttribute="userForm" class="form-signin">
        ...
        <spring:bind path="email">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="email" path="email" class="form-control" placeholder="email" required="true"></form:input>
        ...
        <h7 class="text-center"><a href="${contextPath}/login">Уже зарегистрированы?</a></h7>
    </form:form>
